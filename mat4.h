...
namespace lina { namespace math { 
    class mat4 
    {
        ...
        public:
            ...
            inline friend vector4d operator*(const vector4d& v, const mat4& m);
            inline friend vector3d operator*(const vector3d& v, const mat4& m);
    ...
    inline vector3d operator*(const vector3d& v, const mat4& m)
    {
        return m * v;
    }
